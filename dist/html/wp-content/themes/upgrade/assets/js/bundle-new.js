!function t(e, r, n) {
    ...
    343: [function(t, e, r) {
        ...
        function c(t) {
            return t < 1e3 || t > 5e4 ? (w(".input.money .error").removeClass("hidden-error"), !1) : (w(".input.money .error").addClass("hidden-error"), !0)
        }
        function u(t) {
        ...
        w(document).ready(function() {
            function t() {
                var t = w(".input.money > input").val().replace(/\D+/g, ""),
            ...
            var o = l(document.location.search),
                ...
                v = void 0;
            w(".input.money > input").on("focus", function(t) {
                w(t.target).closest(".input.money").css("z-index", 1)
            }), w(".input.money > input").on("blur", function(t) {
                ...
                w(".input.dropdown").each(function(t, e) {
                    var S = new _.Dropdown(e); S.$el.on("click", function() {
                        function t(r) {
            ...
            }), w(".input.money > input").each(function(t, e) {
            ...
            }), w(".input.money > input").focus(), w(document).on("submit", ".loan-form", function(e) {
                e.preventDefault(), t()
